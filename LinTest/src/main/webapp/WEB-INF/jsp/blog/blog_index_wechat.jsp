  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">收集微信热门文章</h1>
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main">
		   ...
		   <c:forEach items="${weChatArticleList}" var="contentWeChat" varStatus="vs">  <!-- 取出消费细节 -->
	          <div class="blog-post">
	            <h2 class="blog-post-title">${contentWeChat.title}</h2>
	            <p class="blog-post-meta">${contentWeChat.typeName} <a href="${contentWeChat.url}" target="view_window">${contentWeChat.userName} ->点我可以进入原网页</a></p>
          ...
          <nav>
            <ul class="pager">
              <li><a href="${ctx}/blog/jxwechat?id=${id}&page=${page}">Next</a></li>
            </ul>
          </nav>
        ...
        <div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          ...
          <div class="sidebar-module">
            ...
            <ol class="list-unstyled">
              <li><a href="${ctx}/blog">微信热门</a></li>
            </ol>
            <h4>你想返回啥?</h4>
            <ol class="list-unstyled">
              <c:forEach items="${weChatArticleTypeList}" var="contentWeChatType" varStatus="vs">  <!-- 取出消费细节 -->
	              <li><a href="${ctx}/blog/jxwechat?id=${contentWeChatType.id}">${contentWeChatType.name}</a></li>
	          </c:forEach>
            </ol>
          </div>
          <div class="sidebar-module">
